...
const majorLoose = ["计","数","软","信","网","工","智","技"];
...
(function() {
  ...
  (function (open) {
    mWindow.XMLHttpRequest.prototype.open = function (method, url, async, user, pass) {
      ...
      if(/recommendGeekList/.test(url)) {
        // experience103-106  degree本硕博203,204,205 薪资404(5-10)405 406 求职状态 intention: 701,702,703,704
        originUrl = url+"&experience=104,105&degree=203,204,205&salary=405,406&intention=701,703,704&age=22,25";
        // age: 16,-1 gender: -1 switchJobFrequency: -1 exchangeResumeWithColleague: 0 recentNotView: -1
        // activation: -1 school: -1 major: 0
        this.addEventListener("readystatechange", function () {
          console.log("readyState", this.readyState, url, async, user, pass);
  ...
  function addStyle(){
    ...
    for(var i = 0; i< list.length; i++){
      ...
      if(name.indexOf("完全符合")>=0){
        ...
        // color: rgba(0,0,0,.25);
        item.style.cssText = 'background: #f5f5f5; ';
      }
    }
  }
